...
package com.dysen.authenticator.views;
...
import com.dysen.authenticator.R;
  ...
  public CountdownIndicator(Context context, AttributeSet attrs) {
    ...
    if (appearance != null) {
      ...
      for (int i = 0; i < n; i++) {
        ...
        if (attr == R.styleable.CountdownIndicator_color) {
    ...
    mRemainingSectorPaint.setColor(0xffff4444);
  }
